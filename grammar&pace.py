...
audio_file_path = "C:\\gradproject\\presentation-test.wav"
...
print(grammatical_score(transcription,corrected_sentence))
...
audio_file = "C:\\gradproject\\presentation-test.wav"  # Specify your audio file path here
